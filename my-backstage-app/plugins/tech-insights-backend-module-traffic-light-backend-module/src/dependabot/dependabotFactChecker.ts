...
export const DependabotChecks: DynamicThresholdCheck[] = [
  {
    ...
    type: 'number',
    factIds: ['dependabotFactRetriever', 'totalCriticalAlerts'],
    ...
    description:
      'Maximum number of critical Dependabot alerts allowed',
  },
  {
    ...
    annotationKeyThreshold:
      'tech-insights.io/dependabot-high-alert-threshold',
    annotationKeyOperator: 'tech-insights.io/dependabot-operator',
    description:
      'Maximum number of high Dependabot alerts allowed',
  },
    {
    id: 'dependabot-high-alerts',
    name: 'Dependabot High Alerts Count',
    ...
    annotationKeyOperator: 'tech-insights.io/dependabot-operator',
    description:
      'Maximum number of medium Dependabot alerts allowed',
  },
];
