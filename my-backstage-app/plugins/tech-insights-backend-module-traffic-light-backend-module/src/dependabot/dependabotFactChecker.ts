...
export const DependabotChecks: DynamicThresholdCheck[] = [
  {
    ...
    type: 'number',
    factIds: ['dependabotFactRetriever', 'dependabot:alerts:critical'],
  ...
  },
  {
    ...
    type: 'number',
    factIds: ['dependabotFactRetriever', 'dependabot:alerts:high'],
  ...
  },
  {
    ...
    type: 'number',
    factIds: ['dependabotFactRetriever', 'dependabot:alerts:medium'],
