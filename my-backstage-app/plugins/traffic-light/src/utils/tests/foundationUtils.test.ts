import { FoundationUtils, FoundationPipelineMetrics, FoundationPipelineChecks } from '../foundationUtils';
...
describe('FoundationUtils', () => {
  ...
  describe('getFoundationPipelineFacts', () => {
    it('should return parsed facts when data is available', async () => {
      ...
      const result = await foundationUtils.getFoundationPipelineFacts(mockTechInsightsApi, mockEntityRef);

      expect(mockTechInsightsApi.getFacts).toHaveBeenCalledWith(mockEntityRef, ['foundationPipelineStatusFactRetriever']);
  ...
  describe('getFoundationPipelineChecks', () => {
    it('should return correct check results when success rate check is present and true', async () => {
      ...
      const result = await foundationUtils.getFoundationPipelineChecks(mockTechInsightsApi, mockEntityRef);
